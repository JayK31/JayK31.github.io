$(document).ready(function() {
  ...
  $(".tripcollaborator").hide();
  $("#tripcollab-trigger, .tripcollaborator").mouseenter(function() {
    $(".tripcollaborator").fadeIn();
  })
  $("#tripcollab-trigger, .tripcollaborator").mouseleave(function() {
    $(".tripcollaborator").fadeOut();
  })


  $(".cyclesmart").hide();
  $("#cyclesmart-trigger, .cyclesmart").mouseenter(function() {
    $(".cyclesmart").fadeIn();
  })
  $("#cyclesmart-trigger, .cyclesmart").mouseleave(function() {
    $(".cyclesmart").fadeOut();
  })

  $(".twitterfrags").hide();
  $("#twitterfrags-trigger, .twitterfrags").mouseenter(function() {
    $(".twitterfrags").fadeIn();
  })
  $("#twitterfrags-trigger, .twitterfrags").mouseleave(function() {
    $(".twitterfrags").fadeOut();
  }) 

  $(".smoothstreets").hide();
  $("#smoothstreets-trigger, .smoothstreets").mouseenter(function() {
    $(".smoothstreets").fadeIn();
  })
  $("#smoothstreets-trigger, .smoothstreets").mouseleave(function() {
    $(".smoothstreets").fadeOut();
  })
});
